...
import { OrbitControls, useGLTF, Text, Environment, AdaptiveDpr, BakeShadows, PerformanceMonitor, MeshReflectorMaterial } from '@react-three/drei';
...
export default function Experience() {
  ...
  useEffect(() => {
    // Load textures and set parameters
    ...
    const textures = { normal, roughness, color, height, ao, opacity };
  ...
  var sequenceLength = val(sheet.sequence.pointer.length);
  ...
  function animateFooter(){
    ...
    return (
      <>
        ...
        <e.pointLight theatreKey="PointLight2" castShadow={false}  shadow-bias={bias} />
        <e.pointLight theatreKey="PointLight4" castShadow={false}  shadow-bias={bias} />
        <e.pointLight theatreKey="PointLight7" castShadow={false}  shadow-bias={bias} />
        <e.pointLight theatreKey="PointLight8" castShadow={false}  shadow-bias={bias} />
        <e.pointLight theatreKey="PointLight9" castShadow={false}  shadow-bias={bias} />
        <e.pointLight theatreKey="PointLight10" castShadow={false} shadow-bias={bias} />
